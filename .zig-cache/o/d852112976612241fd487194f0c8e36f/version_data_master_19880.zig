//! DO NOT EDIT
//! If you want to specify the zig version, use `zig build -Ddata_version=master`
...
pub const builtins = [_]Builtin{
    ...
    .{
        ...
        ,
        .arguments = &.{
            "value: std.meta.Int(.unsigned, @bitSizeOf(anyerror)",
        },
    },
    .{
        .name = "@errorName",
    ...
    .{
        ...
        .snippet = "@import(${1:comptime path: []const u8})",
        .documentation =
    ...
    .{
        ...
        .arguments = &.{
            "ptr: anytype",
            "comptime options: PrefetchOptions",
        },
    },
    .{
        .name = "@ptrCast",
